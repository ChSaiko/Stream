...
public class Data {
	public static List<Employee> employees() {
		...
		Employee e2 = new Employee("nasim", "blueWorker", 100);
		Employee e3 = new Employee("kacem", "blueWorker", 150);
		Employee e4 = new Employee("karim", "blueWorker", 150);
		Employee e5 = new Employee("hamed", "blueWorker", 100);
		Employee e6 = new Employee("sonia", "teacher", 700);
		Employee e7 = new Employee("soufia", "teacher", 900);
